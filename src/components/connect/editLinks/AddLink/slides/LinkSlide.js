		...
		return (
			<Slide>
				<View
					...
					<Icon
						name={this.props.selected.toLowerCase()}
						style={{ color: 'white', height: 50, fontSize: 50 }}
					/>
					<ProviderLinkMainText>
						{this.props.selected !== 'email' || this.props.selected !== 'phone'
							? `What's your ${this.props.selected}?`
							: null}
					</ProviderLinkMainText>
					<View
						style={{
						...
						<TextField
							label={
								this.props.baseLinks[this.props.selected.toLowerCase()] +
								this.state.link
							}
							baseColor="white"
							tintColor="white"
